    ...
    public partial class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Book>(entity =>
            {
                ...
                entity.Property(e => e.CreatedOn).HasColumnName("CreatedOn_mod");
                entity.Property(e => e.UpdatedOn).HasColumnName("UpdatedOn_mod");
                // Note: IsInStock and IsLowInStock are computed properties, not mapped to database
            });
            ...
            // ReferenceDataItem entity configuration with schema mappings
            ...
            // Preserve existing Book relationships
